...
namespace HindalcoiOS.Form_Collection
{
    public partial class Frm_GlobalEmloyeeHierarchy : XtraForm
    {
        ...
        {
            //txtlocation.Text = HindalcoiOS.Properties.Settings.Default.GeoLocation;
            if (GlobalEmpPages.SelectedIndex == 0)
            {
            ...
            if (GlobalEmpPages.SelectedTab.Text == "Add Department Head")
            {
            ...
            if (GlobalEmpPages.SelectedTab.Text != "Employee Details")
            {
                btnsave.Enabled = false;

            }
            if (GlobalEmpPages.SelectedTab.Text == "Employee Details" || GlobalEmpPages.SelectedTab.Text == "Add Department Head")
            {
                //ResetFunction();
                ...
                DBGridEmp.Columns["emp_code"].HeaderText = "Emp Code";
                DBGridEmp.Columns["GeoTeamId"].HeaderText = "Geo Team Id";
                DBGridEmp.Columns["emp_name"].HeaderText = "Emp Name";
                DBGridEmp.Columns["DeptId"].HeaderText = "Dept Id";
                DBGridEmp.Columns["emailId"].HeaderText = "Email Id";
                DBGridEmp.Columns["EmpSoftcode"].HeaderText = "Soft-Code";
                DBGridEmp.Columns["EmpSoftcode"].HeaderText = "Soft-Code";
                DBGridEmp.Columns["ReportsToEmployeeCode"].HeaderText = "Reports To Employee Code";
        ...
        {
            HideGlobalEmpPagesHeader();
            btnGlbUpd.Enabled = false;
        ...
        private void HideGlobalEmpPagesHeader()
        {
            GlobalEmpPages.Appearance = TabAppearance.FlatButtons;
            GlobalEmpPages.ItemSize = new Size(0, 1);
            GlobalEmpPages.SizeMode = TabSizeMode.Fixed;

            foreach (TabPage tab in GlobalEmpPages.TabPages)
            {
                tab.Hide();// = "";
            }
        }
        ...
        private void btnEmployement_Click(object sender, EventArgs e)
        {
            ...
            if (txtemployement.Text != "" && contains == false && isExists == false)
            {
                ...
                showMessage();
                //  txtemployement.Text = "";
                GlobalEmpPages.SelectedIndex = 0;
        ...
        private void sparrowButton2_Click(object sender, EventArgs e)
        {
            GlobalEmpPages.SelectedIndex = 1;
        }

        private void sparrowButton3_Click(object sender, EventArgs e)
        {
            GlobalEmpPages.SelectedIndex = 2;
        }
    }
}
#endregion