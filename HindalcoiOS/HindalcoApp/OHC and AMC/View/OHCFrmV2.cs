...
namespace HindalcoiOS.OHC_and_AMC.View
{
    public partial class OHCFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public bool ValidationCheck(bool isUpdate)
        {
            ...
            //    txtEmployeeCode.Text = string.Empty;// Clear();
            //    txtEmployeeCode.Focus();
            //    return false;
            //}
            ...
            if (!oHCReport.IsValidId(oHCReport.AadharNumber.ToString()))
            {
                ...
                txtAaDharNo.Text = string.Empty;// Clear();
                txtAaDharNo.Focus();
                return false;
            }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dt = Resources.Instance.GetOHCRecordByYear(txtEmployeeCode.Text,Convert.ToDouble(txtAaDharNo.Text), datetimeCheckDate.Value);
                    if(dt.Rows.Count>0)
                    {
                        XtraMessageBox.Show("Record Already Exists for this year !", ApplicationConstants.MessageDisplay, MessageBoxButtons.OK, MessageBoxIcon.Information);
                        return;
                    }
        ...
        private void txtAaDharNo_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (!string.IsNullOrWhiteSpace(txtAaDharNo.Text))
                {
                    ...
                    {
                        XtraMessageBox.Show("Invalid Aadhar Number");
                        txtAaDharNo.Focus();
                        return;
                    }
        ...
        private void btnExportData_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    FileName = string.Concat(FileName,@"\","OHCFormFormat", DateTime.Now.ToString("dd-MM-yyy"), ".xlsx");
                    ...
                    options.SheetName = "OHC Form Format";
