...
namespace HindalcoiOS.Machine_Edit_Form
{
    public partial class KeySafetyComponent : XtraForm
    {
        ...
        private void btnKeySafetySave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    Resources.Instance.InsertMasterKeycom("Sp_InsertKeySafetyComListMST", this.txtAddKeySafety.Text, "p_keycmplist", "p_returnvalue", out Recultstring);
