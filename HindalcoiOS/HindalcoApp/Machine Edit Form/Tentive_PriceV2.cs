...
{
    public partial class Tentive_Price : XtraForm
    {
        ...
        private void LoadTentiveprice()
        {
            try
            {
                if (this.MachineTag != string.Empty)
                {
                    ...
                    {
                        dt = Resources.Instance.GetDataKey("Sp_TentivePrice", "p_sysgenno", "p_machinename", "p_machineTag", "p_username", "p_userid", this.SysGenNo, this.MachineName, this.MachineTag, "", "0");
                    }
                    else
                    {
                        dt = Resources.Instance.GetDataKey("Sp_TentivePrice", "p_sysgenno", "p_machinename", "p_machineTag", "p_username", "p_userid", this.SysGenNo, this.MachineName, this.MachineTag, GlobalDeclaration._holdInfo[0].UserName, GlobalDeclaration._holdInfo[0].UserId.ToString());
                    }
