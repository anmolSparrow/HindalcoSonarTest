                    ...
                    if (DgvMaitenance.Rows.Count > 0)
                    {
                        if (DgvMaitenance.SelectedRows.Count > 0)
                        {
                            ...
                            if (DgvMaitenance.SelectedRows.Count > 0)
                            {
                                ...
                                SerialNumber--;
                                Resources.Instance.RemoveEntry("Sp_DeleteMaintenenceBasicDetails", "@tagNo", "@MachineName", "@Cadlocation", txttagno.Text, this.MachineName, this.cmblocation.SelectedItem.ToString(), "hh");
                            }
                            else
                            {
