...
namespace HindalcoiOS.PermitToWork
{
    ...
    public partial class PermitQuestionnaire : XtraForm
    {
        ...
        public void ControlCheckBoxCheking()
        {
            if (rdbQ1Y.Checked == true)
            {
                //rdbQ1Y.Checked = false;
