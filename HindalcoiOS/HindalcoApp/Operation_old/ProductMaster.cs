    ...
    public partial class ProductDetails : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void GenerateReport()
        {
            try
            {
                if (isPageLoaded == 1)
                {
                    ...
                    if (tabControl1.SelectedTab.Tag.ToString() == "ProductionMasterTab")
                    {
                        string ProdNo = Resources.Instance.GetIncidentReportNo_RMPCL("SP_GetProductNo");
                    ...
                    if (tabControl1.SelectedTab.Tag.ToString() == "tabMonthlyProd")
                    {
                        string ProdNo = Resources.Instance.GetIncidentReportNo_RMPCL("SP_GetProductTargetCode");
                        if (!string.IsNullOrEmpty(ProdNo))
                        {
                            appArr = ProdNo.Split('/');
                            ProdNo = Convert.ToString(Convert.ToInt32(appArr[2]) + 1);
                    ...
                    if (tabControl1.SelectedTab.Tag.ToString() == "tabDailyProd")
                    {
                        string ProdNo = Resources.Instance.GetIncidentReportNo_RMPCL("SP_GetProductDProdCode");
                        if (!string.IsNullOrEmpty(ProdNo))
                        {
                            appArr = ProdNo.Split('/');
                            ProdNo = Convert.ToString(Convert.ToInt32(appArr[2]) + 1);
                    ...
                    if (tabControl1.SelectedTab.Tag.ToString() == "tabConsumption")
                    {
                        string ProdNo = Resources.Instance.GetIncidentReportNo_RMPCL("SP_GetProductConsumeCode");
                        if (!string.IsNullOrEmpty(ProdNo))
                        {
                            appArr = ProdNo.Split('/');
                            ProdNo = Convert.ToString(Convert.ToInt32(appArr[2]) + 1);
        ...
        private void TabControler(int empRoleId)
        {
            try
            {
                switch (empRoleId)
                {
                    case 1:
                        {
                            tabControl1.TabPages.Remove(tabDailyProd);
                            break;
                        }
                    case 7:
                        {
                    ...
                    case 3:
                        {
                            ...
                            tabControl1.TabPages.Remove(ProductionMasterTab);
                            tabControl1.TabPages.Remove(tabMonthlyProd);
                            break;
                        }
                    case 4:
                        {
        ...
        private void ProductDetails_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                tabControl1.Controls.Remove(tabConsumption);
                ...
                //}
                if(DynamicPrpty !=0 && countryIDs[1].ToString()!="")
                {
        ...
        {
            if ((txtProdCode.Text.Length == 0) || (txtProdCode.Text == ""))
            {
                txtProdCode.Focus();
            ...
            if ((txtProdName.Text.Length == 0) || (txtProdName.Text == ""))
            {
                txtProdName.Focus();
            ...
            if (cmbPlantName.SelectedIndex == 0)
            {
                cmbPlantName.Focus();
            ...
            if ((txtProdCode.Text.Length > 0) && (txtProdName.Text.Length > 0) && (cmbPlantName.SelectedIndex != 0))
            {
                isPageValidated = 1;
            }
            else
            ...
            try
            {
                ...
                if (isPageValidated == 1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            txtClosingStockD.Focus();
                            XtraMessageBox.Show(new Form { TopMost = true, StartPosition = FormStartPosition.CenterScreen }, "Stock cannot be negative", ApplicationConstants.MessageDisplay, MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                    }
                    dts1 = DailyTmpTbl.GetDailyProductionTempTbl("", "", "", "", 0, 0, 0, 0, 0, "", 0, DateTime.Now, DateTime.Now, DateTime.Now, "", "", 2);
                }
       ...
       private void ObjectToClassDailyProduction()
        {
            try
            {
                ...
                lastRowIndex = 0;
                for (lastRowIndex = k; k < DGVDailyProduction.Rows.Count; k++)
                {
                    tabReload = true;
                    ...
                    DailyProd.ClosingStock = Convert.ToDecimal(DGVDailyProduction.Rows[k].Cells[11].Value);
                    DailyProd.EmpCode = DGVDailyProduction.Rows[k].Cells[12].Value.ToString();
                    DailyProd.RoleId = Convert.ToInt32(Convert.ToDecimal(DGVDailyProduction.Rows[k].Cells[13].Value));
                ...
                if (lastRowIndex == DGVDailyProduction.Rows.Count)
                {
                }
                if (m < 0)
                {
                ...
                if (e.ColumnIndex == 1 && e.RowIndex >= 0)
                {
                    if (e.RowIndex >= 0)
                    {
                        ...
                        for(int m=0;m<DGVDailyProduction.Rows.Count;m++)
                        {
                            ...
                            DGVDailyProduction.Rows[m].Cells[2].Value = m+1;
                        }
                    }
                }
        ...
        private void txtMaintTime_Leave(object sender, EventArgs e)
        {

        }

        private void cmbMaintUnit_Leave(object sender, EventArgs e)
        {
            try
            {

                //if (txtMaintTime.Text != "0")
                //{
                //    // txtPowerTrip.Text = Convert.ToString(Convert.ToDecimal(txtMaintTime.Text) + Convert.ToDecimal(txtPowerTrip.Text));
                //    if (cmbPUnit.Text == "Hours")
                //    {
                //        hrArr = txtPowerTrip.Text.Split('.');
                //        totaHr = Convert.ToInt32(hrArr[0]) * 60;
                //        totMin = Convert.ToInt32(hrArr[1]);
                //    }

                //    if (cmbMaintUnit.Text == "Hours")
                //    {
                //        MainhrArr = txtMaintTime.Text.Split('.');
                //        totaHr = Convert.ToInt32(MainhrArr[0]) * 60;
                //        totMin = Convert.ToInt32(MainhrArr[1]);
                //    }
                //    decimal intOut = Convert.ToDecimal((totaHr + totMin) + Convert.ToDecimal(txtMaintTime.Text) * 100);
                //    decimal diVal = intOut / 60;
                //    txtTotalRunTime.Text = Convert.ToString(Convert.ToDecimal(24) - diVal);
                //}
                //else
                //{
                //    txtMaintTime.Text = Convert.ToString(0);
                //    txtPowerTrip.Text = Convert.ToString(Convert.ToDecimal(txtMaintTime.Text) + Convert.ToDecimal(txtPowerTrip.Text));
                //    txtTotalRunTime.Text = Convert.ToString(Convert.ToDecimal(24) - (Convert.ToDecimal(txtPowerTrip.Text) / 60));
                //}
            }
            catch (Exception Ex)
            {
        ...
        private void cmbclosingtargetMon_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            string XmlPath = Application.StartupPath + @"\" + "FinalDsbdRed" + ".xml";
        ...
        private void DashBoardView1_DashboardLoaded(object sender, DevExpress.DashboardWin.DashboardLoadedEventArgs e)
        {
        ...
        private void cmbMainUnit_Leave_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void DashBoardView1_CustomParameters(object sender, CustomParametersEventArgs e)
        {
        }

        private void DashBoardView1_DashboardLoaded_1(object sender, DevExpress.DashboardWin.DashboardLoadedEventArgs e)
        {
        ...
        private void dashboardViewer2_Click(object sender, EventArgs e)
        {
           // MessageBox.Show("Try");
        }
        ...
        private void txtMaintTime_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtPowerTrip_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtProdCode_MouseLeave_1(object sender, EventArgs e)
        {
            try
            {
                txtProdCode.Text.TrimStart(' ');
